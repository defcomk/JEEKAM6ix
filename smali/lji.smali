...
.method public final run()V
    ...
    .prologue
    .line 1
    iget-object v2, p0, Llji;->a:Lljh;

    .line 2
    iget-object v0, v2, Lljh;->i:Lnab;
    ...
    .line 6
    iget-object v4, v2, Lljh;->f:Ljava/lang/Object;

    monitor-enter v4

    .line 7
    :try_start_1
    iget-object v1, v2, Lljh;->e:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    .line 9
    iget-object v5, v2, Lljh;->g:Lnar;

    invoke-virtual {v5}, Lmyb;->isDone()Z
    ...
    .line 10
    iget-object v5, v1, Lliz;->b:Landroid/media/MediaCodec$BufferInfo;

    .line 11
    iget-wide v6, v5, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-wide v8, v2, Lljh;->c:J

    .line 12
    iget-object v5, v2, Lljh;->d:Lljf;

    .line 13
    iget-object v5, v5, Lljf;->b:Landroid/media/MediaFormat;

    const-string v10, "oo.muxer.force_sequential"

    .line 14
    invoke-static {v5, v10}, Lljh;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z
    :try_end_1
    ...
    :goto_0
    :try_start_2
    iget-object v5, v1, Lliz;->a:Ljava/nio/ByteBuffer;
