...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lezj;->f:Ljava/lang/String;
...
.method public constructor <init>(Ladd;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lezj;->h:Landroid/graphics/SurfaceTexture;

    const/4 v0, 0x0

    .line 4
    iput-boolean v0, p0, Lezj;->b:Z

    .line 5
    iput-object p1, p0, Lezj;->a:Ladd;

    .line 6
    iput-object p2, p0, Lezj;->c:Landroid/os/Handler;
...
.method public final declared-synchronized a(Landroid/view/WindowManager;Landroid/content/Context;Ladc;Z)Laes;
    ...
    .line 7
    :try_start_0
    iput-object p3, p0, Lezj;->d:Ladc;

    const/4 v1, 0x1

    .line 8
    iput-boolean v1, p0, Lezj;->e:Z

    .line 9
    iget-object v1, p0, Lezj;->a:Ladd;

    if-nez v1, :cond_0

    .line 10
    sget-object v1, Lezj;->f:Ljava/lang/String;
    ...
    .line 16
    invoke-static {p2, v1}, Lezm;->a(Landroid/content/Context;Ladv;)Lady;
    ...
    .line 21
    invoke-static {v1}, Lezm;->b(Ladv;)Ladx;
    ...
    .line 23
    invoke-static {v1}, Lezm;->a(Ladv;)Ladz;
    ...
    .line 27
    iget-object v3, v0, Lezl;->b:Laes;

    iput-object v3, p0, Lezj;->g:Laes;

    .line 28
    iget-object v3, p0, Lezj;->g:Laes;

    invoke-virtual {v2, v3}, Laek;->a(Laes;)Z

    .line 29
    invoke-static {v1, v2}, Lezm;->a(Ladv;Laek;)V
    ...
    iget-object v1, p0, Lezj;->h:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v1, p0, Lezj;->g:Laes;

    iget-object v2, p0, Lezj;->c:Landroid/os/Handler;

    iget-object v3, p0, Lezj;->d:Ladc;

    invoke-static {v0, v1, v2, v3}, Lezm;->a(Ladd;Laes;Landroid/os/Handler;Ladc;)V

    .line 44
    :goto_2
    iget-object v0, p0, Lezj;->g:Laes;
    ...
    iget-object v1, p0, Lezj;->c:Landroid/os/Handler;

    iget-object v2, p0, Lezj;->d:Ladc;
