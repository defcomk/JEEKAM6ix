...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkwn;->d:Ljava/util/NavigableMap;
...
.method private final declared-synchronized a(J)Ljava/util/Map$Entry;
    ...
    .line 18
    :try_start_0
    iget-object v0, p0, Lkwn;->d:Ljava/util/NavigableMap;
    ...
    invoke-static {v0, p1, p2}, Lkwn;->a(Ljava/util/Map$Entry;J)Ljava/util/Map$Entry;
    :try_end_0
...
.method private final declared-synchronized a(JLjava/util/Map$Entry;Ljava/util/Map$Entry;[F)V
    ...
    invoke-direct {p0, v0, p5}, Lkwn;->a(I[F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(J[F)Z
    ...
    .line 6
    :try_start_0
    invoke-direct {p0, p1, p2}, Lkwn;->a(J)Ljava/util/Map$Entry;

    move-result-object v4

    .line 7
    invoke-direct {p0, p1, p2}, Lkwn;->b(J)Ljava/util/Map$Entry;
    ...
    invoke-direct {p0, v0, p3}, Lkwn;->a(I[F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 10
    invoke-direct/range {v1 .. v6}, Lkwn;->a(JLjava/util/Map$Entry;Ljava/util/Map$Entry;[F)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
