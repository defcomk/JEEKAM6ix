...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgtx;->b:Ljava/nio/file/SimpleFileVisitor;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Lkic;Lkih;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lgtx;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lgtx;->d:Lkic;

    .line 4
    iput-object p3, p0, Lgtx;->e:Lkih;
...
.method private final a(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 50
    iget-object v2, p0, Lgtx;->d:Lkic;

    const-string v3, "Failed to read cached fingerprint"

    invoke-interface {v2, v3, v0}, Lkic;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final a(Ljava/io/InputStream;Ljava/nio/file/Path;)Z
    ...
    .line 90
    :try_start_3
    invoke-static {v1, v2}, Lgtx;->a(Ljava/lang/Throwable;Ljava/util/zip/ZipInputStream;)V
...
.method private final varargs a(Ljava/nio/file/Path;[Ljava/nio/file/Path;)Z
    ...
    .line 68
    sget-object v1, Lgtx;->b:Ljava/nio/file/SimpleFileVisitor;
    ...
    invoke-interface {v2, v3, v1}, Lkic;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_6
...
.method private final b()Ljava/lang/String;
    ...
    .line 104
    :try_start_0
    iget-object v2, p0, Lgtx;->a:Landroid/content/Context;
    ...
    .line 109
    :try_start_2
    invoke-static {v1, v2}, Lgtx;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
    :try_end_2
    ...
    .line 112
    :try_start_4
    invoke-static {v0, v2}, Lgtx;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
...
.method private final d(Ljava/nio/file/Path;)Z
    ...
    .line 92
    :try_start_0
    iget-object v1, p0, Lgtx;->a:Landroid/content/Context;
    ...
    .line 93
    :try_start_1
    invoke-direct {p0, v1, p1}, Lgtx;->a(Ljava/io/InputStream;Ljava/nio/file/Path;)Z
    :try_end_1
    ...
    .line 94
    :try_start_2
    invoke-static {v2, v1}, Lgtx;->a(Ljava/lang/Throwable;Ljava/io/InputStream;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized a()Z
    ...
    .line 14
    iget-object v0, p0, Lgtx;->a:Landroid/content/Context;
    ...
    .line 17
    invoke-direct {p0}, Lgtx;->b()Ljava/lang/String;
    ...
    .line 19
    invoke-direct {p0, v0}, Lgtx;->a(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 21
    :cond_0
    invoke-direct {p0, v0}, Lgtx;->b(Ljava/nio/file/Path;)Z
    ...
    invoke-direct {p0, v3, v7}, Lgtx;->a(Ljava/nio/file/Path;[Ljava/nio/file/Path;)Z
    ...
    .line 23
    invoke-direct {p0, v3}, Lgtx;->d(Ljava/nio/file/Path;)Z
    ...
    .line 24
    invoke-direct {p0, v3}, Lgtx;->c(Ljava/nio/file/Path;)Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-interface {v0, v6}, Lkic;->b(Ljava/lang/String;)V
    ...
    :goto_4
    invoke-interface {v8, v3, v0}, Lkic;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
