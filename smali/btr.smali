...
.field private final g:Lbtp;

.field private final h:Lcjv;


# direct methods
.method constructor <init>(Landroid/content/ContentProvider;Landroid/content/Context;Lciw;Lbtp;Lcjv;Landroid/content/UriMatcher;Lkih;)V
    .locals 1
    ...
    iput-object v0, p0, Lbtr;->a:Lbtn;

    .line 3
    iput-object p1, p0, Lbtr;->e:Landroid/content/ContentProvider;

    .line 4
    iput-object p2, p0, Lbtr;->f:Landroid/content/Context;

    .line 5
    iput-object p3, p0, Lbtr;->b:Lciw;

    .line 6
    iput-object p4, p0, Lbtr;->g:Lbtp;

    .line 7
    iput-object p5, p0, Lbtr;->h:Lcjv;

    .line 8
    iput-object p6, p0, Lbtr;->d:Landroid/content/UriMatcher;

    .line 9
    iput-object p7, p0, Lbtr;->c:Lkih;
...
.method private final a(Landroid/net/Uri;I)Landroid/os/ParcelFileDescriptor;
    ...
    .line 41
    iget-object v0, p0, Lbtr;->g:Lbtp;

    iget-object v2, p0, Lbtr;->f:Landroid/content/Context;
    ...
    .line 46
    iget-object v0, v0, Lbtp;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v1}, Lbtp;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;)Landroid/os/ParcelFileDescriptor;
...
.method public final a(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    .line 12
    :cond_0
    iget-object v0, p0, Lbtr;->d:Landroid/content/UriMatcher;
    ...
    :pswitch_1
    :try_start_0
    iget-object v0, p0, Lbtr;->h:Lcjv;

    invoke-interface {v0, p1}, Lcjv;->a(Landroid/net/Uri;)Landroid/content/ContentProvider$PipeDataWriter;

    move-result-object v5

    .line 14
    iget-object v0, p0, Lbtr;->e:Landroid/content/ContentProvider;
    ...
    invoke-direct {p0, p1, v0}, Lbtr;->a(Landroid/net/Uri;I)Landroid/os/ParcelFileDescriptor;
    ...
    .line 24
    invoke-virtual {v0}, Lckb;->getMessage()Ljava/lang/String;
...
.method public final a(Ljava/lang/String;)Ljava/io/File;
    ...
    .line 25
    iget-object v0, p0, Lbtr;->f:Landroid/content/Context;
