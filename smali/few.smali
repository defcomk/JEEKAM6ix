...
.method constructor <init>(Lobl;)V
    ...
    .line 2
    new-array v0, v0, [Lfex;

    new-instance v1, Lfex;

    const-string v2, "gps"

    invoke-direct {v1, v2}, Lfex;-><init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lfew;->b:[Lfex;

    .line 3
    iput-object p1, p0, Lfew;->d:Lobl;
...
.method public final a(Z)Lnab;
    ...
    .line 9
    iget-boolean v1, p0, Lfew;->e:Z

    if-eq v1, p1, :cond_1

    .line 10
    iput-boolean p1, p0, Lfew;->e:Z
    ...
    .line 12
    iget-object v0, p0, Lfew;->c:Landroid/location/LocationManager;

    if-nez v0, :cond_0

    .line 13
    iget-object v0, p0, Lfew;->d:Lobl;
    ...
    iput-object v0, p0, Lfew;->c:Landroid/location/LocationManager;
    ...
    .line 20
    iget-object v1, p0, Lfew;->c:Landroid/location/LocationManager;

    if-eqz v1, :cond_1

    .line 21
    :goto_3
    iget-object v1, p0, Lfew;->b:[Lfex;
    ...
    .line 22
    :try_start_2
    iget-object v2, p0, Lfew;->c:Landroid/location/LocationManager;
    ...
    invoke-static {v1, v2, v0}, Lbwx;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v3, v1}, Lbwx;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()Landroid/location/Location;
    ...
    .line 7
    iget-boolean v3, v1, Lfex;->b:Z

    if-eqz v3, :cond_1

    iget-object v1, v1, Lfex;->a:Landroid/location/Location;
