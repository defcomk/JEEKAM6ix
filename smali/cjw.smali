...
.method public constructor <init>(Lcik;Lkih;Lcjz;Lcjt;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcjw;->d:Lcik;

    .line 3
    iput-object p2, p0, Lcjw;->a:Lkih;

    .line 4
    iput-object p3, p0, Lcjw;->e:Lcjz;

    .line 5
    iput-object p4, p0, Lcjw;->b:Lcjt;
...
.method public final a(Landroid/net/Uri;)Landroid/content/ContentProvider$PipeDataWriter;
    ...
    .line 15
    :goto_0
    iget-object v0, p0, Lcjw;->d:Lcik;

    invoke-interface {v0, v2, v3}, Lcik;->a(J)Lmed;
    ...
    invoke-direct {v0, v1}, Lckb;-><init>(Ljava/lang/String;)V
    ...
    .line 20
    invoke-interface {v0}, Lcig;->d()Lajh;
    ...
    .line 23
    :cond_1
    iget-object v2, p0, Lcjw;->a:Lkih;

    sget-object v3, Lcic;->a:Ljava/lang/String;
    ...
    .line 25
    invoke-static {v0}, Liru;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v2

    .line 26
    iget-object v0, p0, Lcjw;->a:Lkih;
    ...
    .line 32
    invoke-static {v2, v0}, Liru;->a(Landroid/graphics/Bitmap;Landroid/util/Size;)Landroid/graphics/Bitmap;
    ...
    .line 37
    iget-object v1, p0, Lcjw;->b:Lcjt;

    .line 38
    :goto_2
    invoke-interface {v1, v0}, Lcjs;->a(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
    :try_end_0
    ...
    invoke-direct {v1, p0, v4, v0}, Lcjx;-><init>(Lcjw;Ljava/lang/String;Ljava/io/ByteArrayOutputStream;)V
    ...
    invoke-static {v1, v5}, Lbwx;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Lckb;-><init>(Ljava/lang/Throwable;)V
