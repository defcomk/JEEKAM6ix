...
# direct methods
.method public constructor <init>(Landroid/hardware/SensorManager;Lkic;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lkua;->c:Landroid/hardware/SensorManager;
    ...
    iput-object v0, p0, Lkua;->d:Ljava/util/Set;

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Lkua;->a:Lkuc;
...
.method private final declared-synchronized a()V
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Lkua;->a:Lkuc;

    if-eqz v0, :cond_0

    .line 7
    iget-object v0, p0, Lkua;->b:Lkic;
    ...
    invoke-direct {v1, v0}, Lkur;-><init>(Landroid/hardware/HardwareBuffer;)V

    .line 10
    new-instance v2, Lkue;

    invoke-direct {v2, v1}, Lkue;-><init>(Lkur;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 11
    :try_start_2
    iget-object v3, p0, Lkua;->c:Landroid/hardware/SensorManager;
    ...
    invoke-direct {v4, v1, v0, v3, v2}, Lkuc;-><init>(Lkur;Landroid/hardware/SensorDirectChannel;Landroid/hardware/Sensor;Lkue;)V

    iput-object v4, p0, Lkua;->a:Lkuc;
...
.method private final declared-synchronized b()V
    ...
    .line 21
    iget-object v1, v0, Lkuc;->a:Landroid/hardware/SensorDirectChannel;

    iget-object v2, v0, Lkuc;->d:Landroid/hardware/Sensor;
    ...
    .line 25
    iget-object v0, v0, Lkuc;->c:Lkur;

    .line 26
    iget-object v0, v0, Lkur;->a:Landroid/hardware/HardwareBuffer;
...
# virtual methods
.method public final declared-synchronized a(Ljava/lang/String;)Lkuj;
    .locals 5
    ...
    .line 29
    :try_start_0
    iget-object v0, p0, Lkua;->d:Ljava/util/Set;
    ...
    .line 30
    invoke-direct {p0}, Lkua;->a()V

    .line 31
    :cond_0
    new-instance v0, Lkub;

    invoke-direct {v0, p0, p1}, Lkub;-><init>(Lkua;Ljava/lang/String;)V

    .line 32
    iget-object v1, p0, Lkua;->d:Ljava/util/Set;

    invoke-interface {v1, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 33
    iget-object v2, p0, Lkua;->b:Lkic;

    invoke-interface {v0}, Lkuj;->a()Ljava/lang/String;
...
.method final declared-synchronized a(Lkuj;)V
    .locals 4
    ...
    invoke-interface {p1}, Lkuj;->a()Ljava/lang/String;
