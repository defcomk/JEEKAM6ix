...
.method private final d(F)V
    ...
    iget-object v0, v0, Lbn;->a:Liif;

    .line 63
    iget-object v3, v0, Liif;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;
    ...
    .line 64
    iget-object v0, v0, Liif;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    .line 65
    iget-object v2, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->f:Liht;
    ...
    .line 67
    invoke-virtual {v2, v0}, Liht;->a(I)Lirp;

    move-result-object v0

    .line 68
    iget-object v3, v2, Liht;->d:Landroid/widget/TextView;

    iget-object v4, v2, Liht;->c:Ljava/util/EnumMap;
    ...
    .line 69
    :cond_1
    invoke-virtual {v2, v0}, Liht;->a(Lirp;)V
...
.method public final a()V
    ...
    .line 40
    iget-object v4, v3, Liif;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    .line 41
    iget-object v5, v4, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->f:Liht;
    ...
    .line 43
    invoke-virtual {v5, v4}, Liht;->a(I)Lirp;

    move-result-object v4

    .line 44
    iget-object v5, v3, Liif;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    .line 45
    iget-object v5, v5, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->k:Lffp;

    if-eqz v5, :cond_1

    .line 46
    iget-object v5, v3, Liif;->a:Lirp;

    sget-object v6, Lirp;->o:Lirp;
    ...
    .line 49
    iget-object v6, v3, Liif;->a:Lirp;

    .line 50
    invoke-virtual {v6}, Lirp;->toString()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v4}, Lirp;->toString()Ljava/lang/String;

    move-result-object v7

    .line 51
    invoke-interface {v5, v0, v6, v7}, Lffp;->a(ILjava/lang/String;Ljava/lang/String;)V

    .line 52
    :cond_1
    sget-object v0, Lirp;->o:Lirp;

    iput-object v0, v3, Liif;->a:Lirp;

    .line 53
    iput-wide v8, v3, Liif;->b:J

    .line 54
    iget-object v0, v3, Liif;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    .line 55
    invoke-virtual {v0, v4}, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->b(Lirp;)V

    .line 56
    invoke-virtual {v3, v2}, Liif;->a(Z)V
