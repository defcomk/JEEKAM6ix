...
.field private final synthetic e:Llru;
...
.method public constructor <init>(Llry;Landroid/content/Context;Llru;Ljava/lang/String;Lbv;)V
    .locals 0

    .prologue
    .line 28
    iput-object p1, p0, Lce;->a:Llry;

    iput-object p2, p0, Lce;->c:Landroid/content/Context;

    iput-object p3, p0, Lce;->e:Llru;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {v5, v6}, Llrw;-><init>(Lcf;)V

    move-object v6, p1

    .line 13
    invoke-direct/range {v0 .. v6}, Llrt;-><init>(Landroid/content/Context;Llru;Ljava/lang/String;Lbw;Llrw;Landroid/content/ComponentName;)V

    .line 14
    iget-object v1, p0, Lce;->a:Llry;

    .line 15
    iget-boolean v2, v1, Llry;->c:Z

    if-nez v2, :cond_1

    iput-boolean v8, v1, Llry;->c:Z

    iget-boolean v1, v1, Llry;->d:Z

    if-eqz v1, :cond_0

    sget-object v1, Llry;->a:Ljava/lang/String;
    ...
    .line 19
    iget-object v1, v1, Llry;->e:Ljava/util/List;
    ...
    iget-object v3, p0, Lce;->a:Llry;

    .line 21
    iget-object v3, v3, Llry;->e:Ljava/util/List;
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    .line 32
    iget-object v0, p0, Lce;->a:Llry;

    new-instance v1, Llrr;

    iget-object v2, p0, Lce;->c:Landroid/content/Context;

    invoke-direct {v1, v2, p1}, Llrr;-><init>(Landroid/content/Context;Landroid/content/ComponentName;)V

    .line 33
    iput-object v1, v0, Llry;->b:Llrp;
