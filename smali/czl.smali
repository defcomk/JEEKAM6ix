...
.method public constructor <init>(Lbas;Lcom/google/android/apps/camera/stats/CameraActivitySession;Lffp;Lhzm;Lcom/google/android/apps/camera/stats/Instrumentation;Lcuh;Lkww;Lkck;)V
    .locals 1
    ...
    .line 71
    invoke-direct {p0, v0}, Lbjo;-><init>(Lbbb;)V

    const/4 v0, 0x1

    .line 72
    iput-boolean v0, p0, Lczl;->i:Z
    ...
    iput-object v0, p0, Lczl;->f:Lcom/google/android/apps/camera/stats/CameraActivitySession;
    ...
    iput-object v0, p0, Lczl;->g:Lcom/google/android/apps/camera/stats/Instrumentation;
...
.method public final g()V
    ...
    .line 4
    iget-boolean v1, p0, Lczl;->i:Z

    if-nez v1, :cond_0

    .line 5
    iget-object v1, p0, Lczl;->f:Lcom/google/android/apps/camera/stats/CameraActivitySession;
    ...
    invoke-static {v5, v8}, Lbwx;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 18
    :cond_0
    iput-wide v6, p0, Lczl;->k:J

    .line 19
    iget-object v1, p0, Lczl;->l:Lffp;

    invoke-interface {v1}, Lffp;->d()J

    .line 20
    iget-object v1, p0, Lczl;->h:Lbas;
    ...
    .line 21
    iget-object v4, p0, Lczl;->h:Lbas;

    invoke-interface {v4}, Lbas;->a()Landroid/content/Intent;
    ...
    .line 29
    iget-object v0, p0, Lczl;->l:Lffp;

    .line 30
    invoke-direct {p0}, Lczl;->d()I
    ...
    iget-boolean v6, p0, Lczl;->i:Z

    .line 33
    invoke-interface/range {v0 .. v6}, Lffp;->a(IIIZZZ)V
...
.method public final j()V
    ...
    .line 40
    iget-wide v2, v1, Lffk;->f:J

    cmp-long v2, v2, v8

    if-eqz v2, :cond_0

    iget-wide v2, v1, Lffk;->e:J
    ...
    .line 43
    iget-object v2, v1, Lffk;->g:Lffo;

    .line 44
    iget-boolean v2, v2, Lffo;->a:Z
    ...
    iget-object v1, p0, Lczl;->g:Lcom/google/android/apps/camera/stats/Instrumentation;
    ...
    iput-object v1, v8, Lmwx;->g:[Lmvi;

    .line 64
    iget-object v1, v0, Lcom/google/android/apps/camera/stats/ViewfinderJankSession;->e:Lmvi;

    iput-object v1, v8, Lmwx;->e:Lmvi;

    .line 65
    iget-object v0, v0, Lcom/google/android/apps/camera/stats/ViewfinderJankSession;->f:Lmvi;

    iput-object v0, v8, Lmwx;->f:Lmvi;
    ...
    .line 67
    :goto_3
    invoke-interface {v5, v6, v0, v4}, Lffp;->a(I[Lmwx;Lcom/google/common/logging/nano/eventprotos$LaunchReport;)V
