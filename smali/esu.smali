...
.method private constructor <init>(Landroid/widget/FrameLayout;Liha;Landroid/view/WindowManager;Landroid/view/TextureView$SurfaceTextureListener;Ldjr;)V
    .locals 3
    ...
    iput-object v0, p0, Lesu;->c:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lesu;->m:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lesu;->l:Landroid/graphics/RectF;
    ...
    .line 8
    iput-object v2, p0, Lesu;->i:Landroid/view/View$OnLayoutChangeListener;

    .line 9
    iput-object v2, p0, Lesu;->d:Liha;
    ...
    .line 11
    iput-object p1, p0, Lesu;->f:Landroid/widget/FrameLayout;

    .line 12
    iget-object v0, p0, Lesu;->f:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lesu;->k:Landroid/view/TextureView;

    .line 14
    iget-object v0, p0, Lesu;->k:Landroid/view/TextureView;

    invoke-virtual {v0, p0}, Landroid/view/TextureView;->setSurfaceTextureListener(Landroid/view/TextureView$SurfaceTextureListener;)V

    .line 15
    iput-object p3, p0, Lesu;->p:Landroid/view/WindowManager;

    .line 16
    iput-object p2, p0, Lesu;->d:Liha;

    .line 17
    iput-object p4, p0, Lesu;->e:Landroid/view/TextureView$SurfaceTextureListener;

    .line 18
    iput-object p5, p0, Lesu;->n:Ldjr;

    return-void
.end method

.method public static a(Landroid/view/View;Landroid/view/TextureView$SurfaceTextureListener;Landroid/view/WindowManager;Liha;Ldjr;)Lijk;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lesu;-><init>(Landroid/widget/FrameLayout;Liha;Landroid/view/WindowManager;Landroid/view/TextureView$SurfaceTextureListener;Ldjr;)V

    const-string v1, "TextureViewLegacy --"

    invoke-direct {v6, v1, v0}, Lijl;-><init>(Ljava/lang/String;Lijk;)V
...
.method private final a(Landroid/graphics/RectF;)V
    ...
    iget-object v1, p0, Lesu;->m:Ljava/util/ArrayList;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    .line 124
    iget-object v1, p0, Lesu;->k:Landroid/view/TextureView;

    new-instance v2, Lesv;

    invoke-direct {v2, v0, p1}, Lesv;-><init>(Ljava/util/List;Landroid/graphics/RectF;)V
...
.method private final b(F)V
    ...
    .line 56
    iget-object v2, p0, Lesu;->c:Ljava/util/ArrayList;
...
.method private final b(Landroid/graphics/Matrix;)V
    ...
    .line 78
    iget-object v0, p0, Lesu;->l:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, v0}, Lesu;->a(Landroid/graphics/RectF;)V
...
.method private final g()Z
    ...
    .line 86
    iget-object v0, p0, Lesu;->p:Landroid/view/WindowManager;
    ...
    .line 94
    iget-object v2, v0, Ldjr;->a:Lkhq;

    if-eqz v2, :cond_1

    .line 95
    invoke-virtual {v0, v1, v2}, Ldjr;->a(Lkhq;Lkhq;)Landroid/graphics/Matrix;
    ...
    .line 97
    invoke-direct {p0, v0}, Lesu;->b(Landroid/graphics/Matrix;)V
    ...
    .line 100
    invoke-virtual {v0}, Liha;->a()Landroid/graphics/RectF;
...
.method public final a()V
    ...
    .line 44
    iget-object v0, v0, Liha;->b:Lcom/google/android/apps/camera/ui/views/MainActivityLayout;
    ...
    .line 46
    :cond_0
    invoke-direct {p0, v3}, Lesu;->b(F)V
...
.method public final a(F)V
    ...
    .line 50
    :cond_1
    invoke-direct {p0, p1}, Lesu;->b(F)V

    .line 51
    invoke-direct {p0}, Lesu;->g()Z
...
.method public final a(Landroid/graphics/Matrix;)V
    ...
    .line 66
    invoke-direct {p0, v0}, Lesu;->b(F)V
    ...
    .line 72
    iget-object v3, p0, Lesu;->d:Liha;

    .line 73
    iget-object v3, v3, Liha;->a:Landroid/app/Activity;
    ...
    .line 77
    invoke-direct {p0, p1}, Lesu;->b(Landroid/graphics/Matrix;)V
...
.method public final a(Landroid/view/View$OnLayoutChangeListener;)V
    ...
    .prologue
    .line 83
    iput-object p1, p0, Lesu;->i:Landroid/view/View$OnLayoutChangeListener;
...
.method public final a(Liji;)V
    ...
    .line 125
    iget-object v0, p0, Lesu;->m:Ljava/util/ArrayList;
    ...
    invoke-interface {p1, v0}, Liji;->a(Landroid/graphics/RectF;)V
    ...
    iget-object v1, p0, Lesu;->l:Landroid/graphics/RectF;
...
.method public final onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    .line 32
    iput-boolean v3, p0, Lesu;->h:Z

    .line 33
    :cond_1
    iget-object v0, p0, Lesu;->i:Landroid/view/View$OnLayoutChangeListener;
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    .line 133
    :cond_0
    iget-object v0, p0, Lesu;->e:Landroid/view/TextureView$SurfaceTextureListener;
