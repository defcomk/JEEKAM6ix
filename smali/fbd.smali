...
.method public static a(Lkhq;ILisv;)Landroid/media/MediaFormat;
    .locals 4
...
.method public static a(Lbxv;Lobl;Lobl;Lobl;Lfjz;Lobl;Lkih;)Ljava/util/Set;
    .locals 6
    ...
    .line 43
    invoke-interface {p6, v0}, Lkih;->a(Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lfmn;-><init>(Lkih;Lobl;Lobl;Lobl;Lobl;)V
...
.method public static a(Ljava/lang/Integer;Lobl;Lbxv;Lfjz;Lkih;)Ljava/util/Set;
    .locals 1

    .prologue
    .line 53
    invoke-virtual {p2}, Lbxv;->c()Z
    ...
    .line 56
    invoke-interface {p4, v0}, Lkih;->a(Ljava/lang/String;)V
...
.method public static a(Lobl;Lbxv;Lfjz;Lkih;)Ljava/util/Set;
    .locals 1
    ...
    invoke-direct {v0, p3, p0}, Lfnb;-><init>(Lkih;Lobl;)V
...
.method public static a(Lobl;Lobl;Lobl;Lobl;Lobl;Lobl;Lbxv;Lfjz;Lkih;)Ljava/util/Set;
    .locals 9
    ...
    .line 39
    invoke-interface/range {p8 .. p8}, Lkih;->a()V
    ...
    invoke-direct/range {v1 .. v8}, Lfmm;-><init>(Lkih;Lobl;Lobl;Lobl;Lobl;Lobl;Lobl;)V
...
.method public static a(Lkae;Lfds;Lfem;)V
    .locals 1
    ...
    .line 6
    invoke-virtual {p1, p2}, Lfds;->a(Lfem;)Lfem;
    ...
    invoke-direct {v0, p1, p2}, Lfeq;-><init>(Lfds;Lfem;)V

    invoke-virtual {p0, v0}, Lkae;->execute(Ljava/lang/Runnable;)V

    goto :goto_0
.end method

.method public static a(Lfhv;Lfic;)Z
    .locals 5
    ...
    invoke-interface {p1}, Lfic;->h()Lfig;
    ...
    invoke-interface {v1, v0}, Llls;->b(Ljava/io/File;)Z
    ...
    invoke-interface {v4, v1}, Llls;->b(Ljava/io/File;)Z
...
.method public static b(Ljava/lang/Integer;Lobl;Lbxv;Lfjz;Lkih;)Ljava/util/Set;
    .locals 1
...
.method public final declared-synchronized c()Lfft;
    .locals 1
