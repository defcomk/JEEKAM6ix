...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lerl;->m:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lbfq;Lhqw;Lhqt;)V
    .locals 2
    ...
    iput-object v0, p0, Lerl;->k:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, Lerl;->p:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lerl;->j:Ljava/lang/Boolean;

    .line 9
    iput-object v0, p0, Lerl;->i:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lerl;->o:Ljava/lang/Runnable;
...
.method private static a(Landroid/graphics/Bitmap;Lza;I)Landroid/graphics/Bitmap;
    ...
    .line 95
    invoke-static {p1, v0}, Lerl;->a(Lza;Ljava/lang/String;)I
    ...
    .line 98
    invoke-static {p1, v3}, Lerl;->a(Lza;Ljava/lang/String;)I
    ...
    .line 99
    invoke-static {p1, v4}, Lerl;->a(Lza;Ljava/lang/String;)I
    ...
    .line 100
    invoke-static {p1, v5}, Lerl;->a(Lza;Ljava/lang/String;)I
    ...
    .line 102
    invoke-static {v0, v3}, Lerl;->a(II)Landroid/graphics/Bitmap;
...
.method private final a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1}, Lerl;->a(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 38
    sget-object v0, Lerl;->m:Ljava/lang/String;
    ...
    .line 39
    invoke-virtual {p0}, Lerl;->dismiss()V
    ...
    .line 42
    :try_start_1
    invoke-static {v1}, Lfhz;->a(Ljava/io/InputStream;)Lza;
    :try_end_1
    ...
    .line 43
    invoke-static {v1}, Lerl;->a(Ljava/io/InputStream;)V
    ...
    .line 49
    :goto_1
    invoke-static {v0, v2, v1}, Lerl;->a(Landroid/graphics/Bitmap;Lza;I)Landroid/graphics/Bitmap;
    ...
    .line 51
    :goto_2
    invoke-static {v0}, Lerl;->a(Ljava/io/InputStream;)V
...
.method private final a(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 94
    sget-object v1, Lerl;->m:Ljava/lang/String;
...
.method private static a([B)[B
    ...
    .line 78
    sget-object v2, Lerl;->m:Ljava/lang/String;
...
.method final a()Lert;
    ...
    .prologue
    .line 52
    iget-object v0, p0, Lerl;->k:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 53
    :try_start_0
    iget-object v0, p0, Lerl;->h:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, Lerl;->h:Landroid/graphics/Bitmap;

    .line 55
    iget-object v0, p0, Lerl;->l:Landroid/graphics/Bitmap;
    ...
    .line 56
    iput-object v0, p0, Lerl;->l:Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 58
    iget-object v0, p0, Lerl;->r:Landroid/net/Uri;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, Lerl;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    .line 60
    invoke-static {v1, v1}, Lerl;->a(II)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 61
    invoke-virtual {p0, v0, v1}, Lerl;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v2, v0, v1}, Lert;-><init>([BI)V
    ...
    .line 66
    iget-object v1, p0, Lerl;->k:Ljava/util/concurrent/locks/Lock;
...
.method final a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    .line 110
    iget-object v4, v0, Lerv;->c:Laak;

    iget-object v5, v0, Lerv;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    .line 117
    iget-object v1, v0, Lerv;->c:Laak;

    invoke-virtual {v1, v3}, Laak;->a(F)V

    .line 118
    iget-object v1, v0, Lerv;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    .line 124
    sget-object v0, Lerv;->a:Ljava/lang/String;
...
.method final b()V
    ...
    .prologue
    .line 91
    iget-object v0, p0, Lerl;->p:Landroid/os/Handler;

    iget-object v1, p0, Lerl;->o:Ljava/lang/Runnable;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    .line 15
    invoke-virtual {p0, v0, v1}, Lerl;->setStyle(II)V

    .line 16
    new-instance v0, Lerv;

    invoke-virtual {p0}, Lerl;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {v0, v1}, Lerv;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lerl;->s:Lerv;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 17
    invoke-virtual {p0}, Lerl;->getDialog()Landroid/app/Dialog;
    ...
    iput-object v0, p0, Lerl;->g:Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;

    .line 21
    iget-object v0, p0, Lerl;->g:Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;

    .line 22
    iput-object p0, v0, Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;->c:Leru;
    ...
    invoke-direct {v2, p0}, Lero;-><init>(Lerl;)V
    ...
    invoke-direct {v2, p0}, Lerp;-><init>(Lerl;)V
    ...
    invoke-direct {v2, p0}, Lerq;-><init>(Lerl;)V

    invoke-virtual {v0, v2}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 29
    invoke-virtual {p0}, Lerl;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v0, p0, Lerl;->r:Landroid/net/Uri;

    .line 31
    iget-object v0, p0, Lerl;->r:Landroid/net/Uri;

    invoke-direct {p0, v0, v3}, Lerl;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
