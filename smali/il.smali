...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lil;->a:Ljava/lang/Object;
    ...
    sput-object v0, Lil;->e:Ljava/util/Comparator;

    return-void
.end method

.method public static a(Landroid/content/Context;Lik;Lnv;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    .locals 6
    ...
    .line 35
    iget-object v1, p1, Lik;->b:Ljava/lang/String;
    ...
    invoke-direct {v4, p0, p1, p6, v3}, Lim;-><init>(Landroid/content/Context;Lik;ILjava/lang/String;)V

    if-eqz p4, :cond_1

    .line 39
    :try_start_0
    sget-object v0, Lil;->d:Lir;
    ...
    invoke-direct {v0, p2, p3}, Lrp;-><init>(Lnv;Landroid/os/Handler;)V

    move-object v1, v0

    .line 41
    :goto_1
    sget-object v5, Lil;->a:Ljava/lang/Object;

    monitor-enter v5

    .line 42
    :try_start_1
    sget-object v0, Lil;->b:Ljy;
    ...
    invoke-direct {v1, v3}, Lrq;-><init>(Ljava/lang/String;)V
    ...
    .line 52
    invoke-static {p0, p1, p6}, Lil;->a(Landroid/content/Context;Lik;I)Liq;
    ...
    invoke-virtual {p2, v1, p3}, Lnv;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 56
    :cond_8
    invoke-virtual {p2, v1, p3}, Lnv;->a(ILandroid/os/Handler;)V
    ...
    .line 57
    invoke-virtual {p2, v0}, Lnv;->a(Landroid/graphics/Typeface;)V
...
.method static a(Landroid/content/Context;Lik;I)Liq;
    .locals 12
    ...
    .line 2
    iget-object v2, p1, Lik;->c:Ljava/lang/String;
    ...
    .line 6
    iget-object v8, p1, Lik;->d:Ljava/lang/String;
    ...
    .line 9
    iget-object v2, p1, Lik;->d:Ljava/lang/String;
    ...
    .line 16
    :cond_2
    sget-object v0, Lil;->e:Ljava/util/Comparator;

    invoke-static {v9, v0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 17
    iget-object v0, p1, Lik;->a:Ljava/util/List;
    ...
    invoke-direct {v0, v1, v2}, Lio;-><init>(I[Lip;)V
    :try_end_1
    ...
    invoke-static {p0, p1, v0}, Lil;->a(Landroid/content/Context;Lik;Ljava/lang/String;)[Lip;
    ...
    invoke-direct {v0, v2, v1}, Lio;-><init>(I[Lip;)V
    :try_end_2
...
.method private static a(Landroid/content/Context;Lik;Ljava/lang/String;)[Lip;
    .locals 19
    ...
    iget-object v7, v0, Lik;->e:Ljava/lang/String;
