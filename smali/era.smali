...
.method constructor <init>(Landroid/app/Activity;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lera;->a:Landroid/app/Activity;
...
.method public final onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 3
    iget-object v1, p0, Lera;->a:Landroid/app/Activity;
    ...
    sget-object v2, Lbbw;->f:Landroid/net/Uri;

    .line 6
    iput-object v2, v1, Lcom/google/android/gms/googlehelp/GoogleHelp;->f:Landroid/net/Uri;

    .line 7
    iget-object v2, v0, Lbbw;->c:Landroid/content/Context;
    ...
    sget-object v5, Lbbw;->e:Landroid/net/Uri;
    ...
    sget-object v5, Lbbw;->g:Landroid/net/Uri;
    ...
    .line 17
    iget-object v0, v0, Lbbw;->b:Landroid/app/Activity;

    invoke-direct {v2, v0}, Ljkt;-><init>(Landroid/app/Activity;)V
    ...
    :cond_1
    iget-object v0, v2, Ljkt;->a:Landroid/app/Activity;
    ...
    iget-object v0, v2, Ljkt;->b:Ljgx;

    new-instance v3, Ljku;

    const/4 v4, 0x0

    invoke-direct {v3, v2, v1, v4}, Ljku;-><init>(Ljkt;Landroid/content/Intent;Ljava/util/List;)V

    invoke-static {v0, v3}, Ljlv;->a(Ljgx;Ljlz;)V

    :goto_0
    return v6

    :cond_2
    invoke-virtual {v2, v0, v1}, Ljkt;->a(ILandroid/content/Intent;)V
