...
.field public static final b:Ljgi;
...
.method public static a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 1
    invoke-static {p0, p1, v1}, Ljgk;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    new-instance v2, Ljin;

    invoke-direct {v2, v1, p0, p2}, Ljin;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V
    ...
    :cond_1
    invoke-static {p0, p1}, Ljim;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0, p1}, Ljim;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_1
    invoke-static {p0, p1}, Ljim;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Ljrb;)Ljra;
    .locals 2
    ...
    invoke-direct {v0, p1}, Ljra;-><init>(Ljrb;)V

    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iput-object p0, v0, Ljra;->a:Landroid/content/Context;

    const-string v1, "com.google.android.gms"

    invoke-static {p0, v1}, Ljgm;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1}, Ljrb;->a()V
...
.method public final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {v0, p0, p1}, Ljgj;-><init>(Ljgi;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2}, Ljim;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Ljim;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Ljrl;->a(Landroid/content/Context;)Z
    ...
    :pswitch_0
    sget-object v0, Ljgm;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final b(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 4
    invoke-static {p1, p2, p3, p4}, Ljgi;->a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-direct {v3}, Ljgo;-><init>()V

    const-string v4, "Cannot display null dialog"

    invoke-static {v0, v4}, Liwp;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, v3, Ljgo;->mDialog:Landroid/app/Dialog;

    if-eqz p4, :cond_0

    iput-object p4, v3, Ljgo;->a:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object v0, v3, Ljgh;->a:Landroid/app/Dialog;

    if-eqz p4, :cond_2

    iput-object p4, v3, Ljgh;->b:Landroid/content/DialogInterface$OnCancelListener;
