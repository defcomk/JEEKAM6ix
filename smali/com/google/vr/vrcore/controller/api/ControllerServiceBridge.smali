...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)V
    ...
    invoke-direct {v0, p3}, Lnoj;-><init>(I)V

    invoke-direct {p0, p1, p2, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;-><init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lnoj;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lnoj;)V
    .locals 3
    ...
    invoke-direct {v0, p2, p3, v1}, Lnov;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lnoj;I)V

    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Lnov;

    .line 6
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->b:Landroid/util/SparseArray;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Lnov;
    ...
    invoke-direct {v0, p0}, Lnpf;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V

    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->h:Lnpf;
...
.method private static a(Landroid/content/Context;)I
    ...
    :try_end_0
    .catch Lnnp; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Lnof;)V
    ...
    .line 97
    invoke-static {}, Lnof;->f()J

    move-result-wide v0

    .line 98
    iget-wide v2, p0, Lnof;->o:J
...
.method private final a(ILnov;)Z
    .locals 3

    .prologue
    .line 100
    :try_start_0
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lnpc;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->i:Ljava/lang/String;

    new-instance v2, Lnpb;

    invoke-direct {v2, p2}, Lnpb;-><init>(Lnov;)V

    invoke-interface {v0, p1, v1, v2}, Lnpc;->a(ILjava/lang/String;Lnpa;)Z
    :try_end_0
...
.method public final a()V
    ...
    invoke-interface {v0, v1}, Lnpc;->a(Ljava/lang/String;)Z
    :try_end_0
    ...
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->h:Lnpf;

    invoke-interface {v0, v1}, Lnpc;->b(Lnpe;)Z
    :try_end_1
    ...
    .line 23
    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lnpc;
...
.method public final b()V
    ...
    .prologue
    .line 80
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Lnov;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILnov;)Z
...
.method public createAndConnectController(ILcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)Z
    ...
    .line 30
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lnpc;
    ...
    invoke-direct {v1, p2, v0, p1}, Lnov;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lnoj;I)V

    .line 32
    iget v0, v1, Lnov;->b:I

    invoke-direct {p0, v0, v1}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILnov;)Z
    ...
    .line 34
    iput-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Lnov;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->h:Lnpf;

    invoke-interface {v0, v2}, Lnpc;->a(Lnpe;)Z
    ...
    invoke-direct {v0, p2}, Lnpd;-><init>(Landroid/os/IBinder;)V
...
.method public requestBind()V
    ...
    invoke-direct {v1, p0}, Lnor;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public requestUnbind()V
    ...
    invoke-direct {v1, p0}, Lnos;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public vibrateController(IIII)V
    ...
    .line 48
    invoke-direct {v1}, Lnop;-><init>()V

    .line 49
    invoke-virtual {v0}, Lniv;->getSerializedSize()I
    ...
    .line 51
    invoke-static {v0, v3, v2, v4}, Lniv;->toByteArray(Lniv;[BII)V
    ...
    invoke-direct {v2, p0, p1, v1}, Lnot;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILnop;)V
