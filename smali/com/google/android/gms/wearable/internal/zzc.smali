...
.method public constructor <init>(Landroid/os/IBinder;[Landroid/content/IntentFilter;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Ljwg;->a(Landroid/os/IBinder;)Ljwf;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/wearable/internal/zzc;->a:Ljwf;
...
.method public constructor <init>(Ljxh;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/wearable/internal/zzc;->a:Ljwf;

    iget-object v0, p1, Ljxh;->b:[Landroid/content/IntentFilter;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/wearable/internal/zzc;->a:Ljwf;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Ljwf;->asBinder()Landroid/os/IBinder;
    ...
    invoke-static {p1, v2, v0}, Liwp;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V

    const/4 v0, 0x3

    iget-object v2, p0, Lcom/google/android/gms/wearable/internal/zzc;->b:[Landroid/content/IntentFilter;

    invoke-static {p1, v0, v2, p2}, Liwp;->a(Landroid/os/Parcel;I[Landroid/os/Parcelable;I)V

    const/4 v0, 0x4

    iget-object v2, p0, Lcom/google/android/gms/wearable/internal/zzc;->c:Ljava/lang/String;

    invoke-static {p1, v0, v2}, Liwp;->a(Landroid/os/Parcel;ILjava/lang/String;)V
    ...
    invoke-static {p1, v1}, Liwp;->o(Landroid/os/Parcel;I)V
