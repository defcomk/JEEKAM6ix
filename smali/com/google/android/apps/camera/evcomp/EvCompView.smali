...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, v1}, Lcbi;-><init>(Landroid/content/res/Resources;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;
...
.method public constructor <init>(Landroid/content/Context;Lcbi;)V
    ...
    .line 3
    iput-object p2, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iput-object v0, v1, Lcbi;->a:Landroid/graphics/Canvas;

    .line 47
    move-object/from16 v0, p1

    invoke-virtual {v1, v0}, Lcbi;->b(Landroid/graphics/Canvas;)I
    ...
    invoke-virtual {v1, v0}, Lcbi;->c(Landroid/graphics/Canvas;)I
    ...
    iget-object v2, v0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;

    .line 52
    iget-object v1, v2, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v2, v1}, Lcbi;->a(Landroid/graphics/Canvas;)I
    ...
    .line 56
    iget-object v2, v1, Lcbi;->t:Landroid/graphics/drawable/Drawable;
    ...
    .line 57
    iget-object v3, v1, Lcbi;->t:Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    iget-object v4, v1, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v1, v4}, Lcbi;->c(Landroid/graphics/Canvas;)I

    move-result v4

    .line 59
    iget-object v5, v1, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v1, v5}, Lcbi;->a(Landroid/graphics/Canvas;)I
    ...
    .line 61
    invoke-virtual {v1, v5, v4}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    iget-object v5, v1, Lcbi;->t:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Lcbi;->a:Landroid/graphics/Canvas;
    ...
    .line 73
    iget-object v4, v2, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v2, v4}, Lcbi;->a(Landroid/graphics/Canvas;)I
    ...
    .line 76
    invoke-virtual {v2, v4, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    .line 77
    invoke-virtual {v2, v5, v7}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    .line 78
    invoke-virtual {v2, v5, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    iget-object v3, v2, Lcbi;->d:Landroid/graphics/Paint;
    ...
    iget-object v2, v2, Lcbi;->s:Landroid/graphics/Paint;
    ...
    iget-object v10, v0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;
    ...
    .line 92
    iget v1, v10, Lcbi;->m:I

    invoke-virtual {v10, v1}, Lcbi;->a(I)I
    ...
    .line 93
    iget v3, v10, Lcbi;->m:I

    .line 94
    iget v4, v10, Lcbi;->i:F

    mul-float v5, v4, v11

    .line 95
    iget v6, v10, Lcbi;->f:F

    .line 96
    iget v7, v10, Lcbi;->h:F

    .line 97
    iget v8, v10, Lcbi;->w:F
    ...
    .line 102
    invoke-virtual {v10, v3, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v14

    .line 103
    invoke-virtual {v10, v2, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v1

    .line 104
    invoke-virtual {v10, v13, v6}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v2

    iget v3, v10, Lcbi;->e:F

    add-float/2addr v3, v8

    .line 105
    invoke-virtual {v10, v3, v6}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v3

    .line 106
    invoke-virtual {v10, v8, v6}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v4

    iget v5, v10, Lcbi;->e:F

    add-float/2addr v5, v6

    .line 107
    invoke-virtual {v10, v8, v5}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v5

    iget v6, v10, Lcbi;->e:F
    ...
    .line 109
    invoke-virtual {v10, v8, v9}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v7

    iget v15, v10, Lcbi;->e:F
    ...
    .line 111
    invoke-virtual {v10, v13, v9}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v9

    .line 112
    invoke-static/range {v1 .. v9}, Lmiv;->a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lmiv;
    ...
    .line 128
    iget-object v1, v10, Lcbi;->a:Landroid/graphics/Canvas;

    iget-object v2, v10, Lcbi;->d:Landroid/graphics/Paint;
    ...
    iget-object v2, v10, Lcbi;->s:Landroid/graphics/Paint;
    ...
    .line 132
    iget-object v5, v10, Lcbi;->u:Landroid/graphics/Paint;

    iget v6, v10, Lcbi;->v:F
    ...
    .line 134
    iget-object v6, v10, Lcbi;->u:Landroid/graphics/Paint;
    ...
    .line 137
    iget-object v5, v2, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v2, v1, v5}, Lcbi;->a(ILandroid/graphics/Canvas;)F

    move-result v5

    .line 138
    invoke-virtual {v2, v3, v5}, Lcbi;->a(FF)Landroid/graphics/PointF;

    move-result-object v5

    .line 139
    iget-object v6, v2, Lcbi;->a:Landroid/graphics/Canvas;
    ...
    iget-object v10, v2, Lcbi;->d:Landroid/graphics/Paint;
    ...
    iget-object v9, v2, Lcbi;->s:Landroid/graphics/Paint;
    ...
    invoke-virtual {v2, v1, v4}, Lcbi;->a(ILandroid/graphics/Canvas;)F

    move-result v4

    .line 146
    invoke-virtual {v2, v3, v4}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    iget-object v9, v2, Lcbi;->d:Landroid/graphics/Paint;
    ...
    iget-object v8, v2, Lcbi;->s:Landroid/graphics/Paint;
    ...
    iget-object v8, v0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;
    ...
    .line 150
    iget-object v1, v8, Lcbi;->a:Landroid/graphics/Canvas;

    invoke-virtual {v8, v1}, Lcbi;->a(Landroid/graphics/Canvas;)I
    ...
    invoke-virtual {v8, v7, v1}, Lcbi;->a(ILandroid/graphics/Canvas;)F
    ...
    .line 154
    invoke-virtual {v8, v10, v3}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    .line 155
    invoke-virtual {v8, v3, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    iget-object v6, v8, Lcbi;->d:Landroid/graphics/Paint;
    ...
    iget-object v6, v8, Lcbi;->s:Landroid/graphics/Paint;
...
.method protected onLayout(ZIIII)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->g:Lish;

    .line 22
    iget-object v0, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->h:Lcbi;

    iget-object v1, p0, Lcom/google/android/apps/camera/evcomp/EvCompView;->g:Lish;

    .line 23
    iput-object v1, v0, Lcbi;->p:Lish;
    ...
    invoke-virtual {v0, v2}, Lcbi;->a(I)I
    ...
    invoke-virtual {v0, v6, v1}, Lcbi;->a(FF)Landroid/graphics/PointF;
    ...
    .line 37
    invoke-virtual {v0, v3, v2}, Lcbi;->a(FF)Landroid/graphics/PointF;
