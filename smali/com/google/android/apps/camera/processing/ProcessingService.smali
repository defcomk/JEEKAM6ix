...
.method public constructor <init>()V
    ...
    .line 3
    invoke-direct {v0, p0}, Lhih;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    .line 4
    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->x:Lhih;
...
.method private final b()V
    ...
    invoke-interface {v0, p0}, Lhig;->a(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    .line 103
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->b:Lkvc;

    .line 104
    iget-boolean v0, v0, Lkvc;->e:Z
...
.method public final a()V
    ...
    invoke-direct {v2, p0}, Lhif;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V
...
.method public final a(Limn;)V
    ...
    invoke-interface {p1, v1}, Limn;->a(Landroid/content/res/Resources;)Ljava/lang/String;
...
.method public onCreate()V
    ...
    .line 16
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->q:Lkih;
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lhio;-><init>(Landroid/os/PowerManager;Ljava/lang/String;J)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lhio;

    .line 20
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lhio;
    ...
    iget-object v4, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->x:Lhih;
    ...
    .line 49
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->o:Lbxh;

    invoke-interface {v0}, Lbxh;->c()Z
...
.method public onDestroy()V
    ...
    iget-object v9, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->x:Lhih;
    ...
    .line 74
    iget-object v1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->n:Lhil;

    .line 75
    iget-object v2, v1, Lhil;->b:Ljava/lang/Object;
    ...
    .line 77
    iget-object v3, v1, Lhil;->c:Lkic;

    const-string v4, "Service destroyed, restarting? "

    iget-boolean v0, v1, Lhil;->e:Z
    ...
    .line 79
    iget-object v0, v1, Lhil;->d:Ljava/util/LinkedList;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 92
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->m:Lffg;

    .line 93
    new-instance v1, Lffh;

    invoke-direct {v1, v0}, Lffh;-><init>(Lffg;)V
    ...
    invoke-direct {v2, p0, v1}, Lhid;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lffh;)V

    const/16 v1, 0x9

    const-string v3, "CameraProcessingThread"

    invoke-direct {v0, v1, v2, v3}, Ljzh;-><init>(ILjava/lang/Runnable;Ljava/lang/String;)V
