...
.field private i:Lifm;

.field private j:Lifo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    iput-object v1, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->c:Ljes;
    ...
    invoke-direct {v0, p0}, Ljer;-><init>(Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;)V
    ...
    invoke-direct {v1, p0, p1}, Ljes;-><init>(Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;Landroid/content/Context;)V

    iput-object v1, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->c:Ljes;

    .line 16
    iget-object v1, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->c:Ljes;
    ...
    invoke-direct {v0, p1, p2}, Lifm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v0, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->i:Lifm;

    .line 18
    iget-object v0, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->i:Lifm;

    new-instance v1, Landroid/widget/FrameLayout$LayoutParams;

    invoke-direct {v1, v4, v4}, Landroid/widget/FrameLayout$LayoutParams;-><init>(II)V

    invoke-virtual {v0, v1}, Lifm;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 19
    new-instance v0, Lifo;

    iget-object v1, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->i:Lifm;

    new-instance v2, Lkae;

    invoke-direct {v2}, Lkae;-><init>()V

    invoke-direct {v0, v1, v2}, Lifo;-><init>(Lifk;Lkae;)V

    iput-object v0, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->j:Lifo;
...
.method public final a()V
    ...
    .line 25
    iget-object v0, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->b:Ljet;

    if-eqz v0, :cond_0

    .line 26
    invoke-interface {v0}, Ljet;->a()F
...
.method public final a(Landroid/graphics/RectF;)V
    ...
    .line 49
    iget-object v0, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->j:Lifo;

    .line 50
    iget-object v1, v0, Lifo;->c:Lkae;

    new-instance v2, Lifr;

    invoke-direct {v2, v0, p1}, Lifr;-><init>(Lifo;Landroid/graphics/RectF;)V
...
.method public final a(ZF)V
    ...
    .line 35
    iget-object v1, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->j:Lifo;
    ...
    .line 36
    iget-boolean v3, v1, Lifo;->d:Z

    if-eqz v3, :cond_2

    .line 37
    iget-object v3, v1, Lifo;->c:Lkae;

    new-instance v4, Lifp;

    invoke-direct {v4, v1, v0, v2}, Lifp;-><init>(Lifo;II)V
    ...
    invoke-direct {v2, v0, v3}, Lifs;-><init>(Lifo;F)V
    ...
    .line 41
    :cond_5
    iget-object v2, p0, Lcom/google/android/apps/refocus/viewer/RGBZFocusControls;->b:Ljet;

    if-eqz v2, :cond_0

    .line 42
    invoke-interface {v2, p2}, Ljet;->a(F)V
...
.method public final a(ZII)V
    ...
    .line 45
    invoke-interface {v0, p2, p3}, Ljet;->a(II)V
    ...
    .line 47
    iget-object v3, v0, Lifo;->c:Lkae;

    new-instance v4, Lifq;

    invoke-direct {v4, v0, v1, v2}, Lifq;-><init>(Lifo;II)V
