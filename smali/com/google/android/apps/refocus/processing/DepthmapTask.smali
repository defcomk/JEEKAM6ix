...
.field public final dataset:Ljdu;
...
.field public final location:Lmed;

.field public final maxNativeMemory:Lfhk;

.field public final memoryManager:Lfhm;
...
.field public final sessionManager:Lhqw;

.field public final startTimeMillis:J

.field public final usageStatistics:Lffp;
...
.method public constructor <init>(Lfhm;Ljdu;IIZLjava/lang/String;Lmed;Lhqb;Lfhk;Lbtj;Lffp;Lhqw;)V
    .locals 3
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfhm;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Ljdu;
    ...
    .line 8
    iput-object p7, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmed;
    ...
    .line 10
    iput-object p8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;
    ...
    .line 13
    iput-object p9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfhk;

    .line 14
    iput-object p10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lbtj;

    .line 15
    iput-object p11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lffp;
    ...
    .line 17
    iput-object p12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lhqw;

    return-void
.end method

.method public constructor <init>(Lfhm;Ljdu;Ljava/util/List;Lcom/google/android/apps/refocus/image/ColorImage;IIZLjava/lang/String;Lmed;Lhqw;Lfhk;Lbtj;Lffp;Lhto;Lhsy;)V
    .locals 9
    ...
    iput-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmed;
    ...
    invoke-direct {v8, v0, v2, v3}, Lhwn;-><init>(Lhto;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 32
    invoke-virtual/range {v3 .. v8}, Lhsy;->a(Ljava/lang/String;Lmed;JLhwn;)Lhst;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;

    .line 33
    move-object/from16 v0, p10

    iput-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lhqw;

    .line 34
    move-object/from16 v0, p11

    iput-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfhk;

    .line 35
    move-object/from16 v0, p12

    iput-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lbtj;

    .line 36
    move-object/from16 v0, p13

    iput-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lffp;
...
.method static synthetic access$100(Lcom/google/android/apps/refocus/processing/DepthmapTask;)Ljdu;
    .locals 1

    .prologue
    .line 235
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Ljdu;
...
.method private computeRGBZ(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/ProgressCallback;Z)Lcom/google/android/apps/refocus/image/RGBZ;
    ...
    .line 157
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;
    ...
    invoke-interface {v1, v2}, Lhqb;->a(Limn;)V

    .line 158
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lbtj;

    invoke-static {p1, v1, v0, p2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->renderRGBZ(Landroid/content/Context;Lbtj;Lcom/google/android/apps/refocus/image/RGBZ;Lcom/google/android/apps/refocus/processing/ProgressCallback;)V
...
.method private failAndFinish()V
    ...
    .line 103
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;
...
.method private getFrame(I)Lcom/google/android/apps/refocus/image/ColorImage;
    ...
    invoke-virtual {v0, p1}, Ljdu;->a(I)Ljava/lang/String;
...
.method private getNumFrames()I
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Ljdu;

    invoke-virtual {v2, v0}, Ljdu;->a(I)Ljava/lang/String;
...
.method private getReferenceBitmap(ZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v2}, Ljdu;->a()Ljava/lang/String;
    ...
    .line 187
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Ljdu;
...
.method private isHighResSupported(Lfhm;)Z
    .locals 4

    .prologue
    .line 195
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfhk;

    .line 196
    iget-wide v0, v0, Lfhk;->a:J
...
.method private isValid()Z
    ...
    .line 161
    iget-object v3, v2, Ljdu;->b:Ljava/lang/String;

    if-eqz v3, :cond_1

    iget-object v3, v2, Ljdu;->a:Ljava/lang/String;

    if-eqz v3, :cond_1

    new-instance v3, Ljava/io/File;

    invoke-virtual {v2}, Ljdu;->b()Ljava/lang/String;
...
.method private processInternal(Landroid/content/Context;Lfhm;Lhqb;)V
    .locals 2
    ...
    invoke-direct {v0, p3}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Lhqb;)V

    .line 87
    invoke-direct {p0, p2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->isHighResSupported(Lfhm;)Z
...
.method private removeTemporaryFiles()V
    ...
    invoke-virtual {v0, v1}, Ljdu;->a(I)Ljava/lang/String;
...
.method private static renderRGBZ(Landroid/content/Context;Lbtj;Lcom/google/android/apps/refocus/image/RGBZ;Lcom/google/android/apps/refocus/processing/ProgressCallback;)V
    .locals 6
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/android/apps/refocus/processing/FaceDetector;-><init>(Landroid/content/Context;Lbtj;)V
...
.method private saveAndFinish(Lcom/google/android/apps/refocus/image/RGBZ;)V
    ...
    .line 122
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lffp;
    ...
    .line 124
    invoke-interface/range {v0 .. v5}, Lffp;->a(Ljava/lang/String;Lcom/google/android/libraries/camera/exif/ExifInterface;ZFZ)V
...
.method private setExifTags(IILcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    .line 105
    iget-object v0, p3, Lcom/google/android/libraries/camera/exif/ExifInterface;->R:Lkkd;

    const/4 v1, 0x0

    .line 106
    iput-object v1, v0, Lkkd;->d:[B
    ...
    invoke-virtual {p3, v0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lkkn;

    move-result-object v0

    invoke-virtual {p3, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lkkn;)Lkkn;
...
.method public getName()Ljava/lang/String;
    ...
    .line 39
    iget-object v0, v0, Ljdu;->a:Ljava/lang/String;
...
.method public process(Landroid/content/Context;)V
    ...
    .line 40
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfhm;

    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;

    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->processInternal(Landroid/content/Context;Lfhm;Lhqb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public save()Lcom/google/android/apps/refocus/processing/DepthmapTask;
    ...
    .line 63
    iget-object v5, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Ljdu;

    invoke-virtual {v5, v1}, Ljdu;->a(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfhm;
    ...
    iget-object v7, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmed;

    iget-object v8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;

    iget-object v9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfhk;

    iget-object v10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gservicesHelper:Lbtj;

    iget-object v11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lffp;

    iget-object v12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lhqw;

    invoke-direct/range {v0 .. v12}, Lcom/google/android/apps/refocus/processing/DepthmapTask;-><init>(Lfhm;Ljdu;IIZLjava/lang/String;Lmed;Lhqb;Lfhk;Lbtj;Lffp;Lhqw;)V
...
.method public startSession(Z)V
    ...
    .line 76
    :cond_2
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lhqw;

    iget-object v3, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;

    invoke-interface {v2, v3}, Lhqw;->a(Lhqb;)V

    if-eqz p1, :cond_3

    .line 77
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Lhqb;
    ...
    .line 79
    invoke-static {v3, v0}, Lijm;->a(I[Ljava/lang/Object;)Limn;

    move-result-object v0

    sget-object v3, Lhrg;->f:Lhrg;

    .line 80
    invoke-interface {v2, v1, v0, v3}, Lhqb;->a([BLimn;Lhrg;)V
