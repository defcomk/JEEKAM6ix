...
# instance fields
.field public mBestInputBitmap:Lllh;
...
.method private constructor <init>(IILjava/nio/ByteBuffer;Z)V
    ...
    .line 4
    iput-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Lllh;
...
.method private declared-synchronized closeInputBitmap()V
    ...
    .line 21
    :try_start_0
    iget-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Lllh;

    if-eqz v0, :cond_0

    .line 22
    invoke-interface {v0}, Lllh;->close()V
...
# virtual methods
.method public declared-synchronized addPhoto(Lllh;Ljava/util/List;J)V
    .locals 15
    ...
    .line 27
    :cond_0
    iget-object v2, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Lllh;
    ...
    .line 31
    invoke-interface/range {p1 .. p1}, Lllh;->a()Ljava/lang/Object;
    ...
    .line 38
    invoke-interface/range {p1 .. p1}, Lllh;->close()V
    :try_end_2
    ...
    .line 50
    iget-object v3, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Lllh;

    if-eq v2, v3, :cond_1

    .line 51
    invoke-interface {v2}, Lllh;->close()V
    :try_end_3
...
.method public declared-synchronized createAllSmiles(Lllg;Z)Lllh;
    .locals 4
    ...
    .line 83
    iput-object v1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Lllh;
    :try_end_1
    ...
    .line 89
    invoke-static {p1, v0}, Llmq;->a(Lllg;Ljava/nio/ByteBuffer;)Lllh;
    :try_end_3
...
.method public declared-synchronized createAnimation(Lllg;ZI)Ljava/util/List;
    .locals 8
    ...
    invoke-direct {v1, v0}, Llmh;-><init>(Lllh;)V
    ...
    invoke-direct {v0, v1, v3}, Llmh;-><init>(Llmh;B)V
    ...
    invoke-static {p1, v6}, Llmq;->a(Lllg;Ljava/nio/ByteBuffer;)Lllh;
