...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Ljgm;->c:Z

    sput-boolean v1, Ljgm;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ljgm;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ljgm;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Ljgm;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    :cond_0
    invoke-static {p0}, Ljrl;->a(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_b

    sget-object v3, Ljrl;->a:Ljava/lang/Boolean;
    ...
    sput-object v3, Ljrl;->a:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Ljgn;->a(Landroid/content/Context;)Ljgn;

    if-eqz v4, :cond_8

    sget-object v4, Ljjq;->a:[Ljjn;

    invoke-static {v3, v4}, Ljgn;->a(Landroid/content/pm/PackageInfo;[Ljjn;)Ljjn;

    move-result-object v3

    if-eqz v3, :cond_7

    new-array v4, v1, [Ljjn;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Ljgn;->a(Landroid/content/pm/PackageInfo;[Ljjn;)Ljjn;
    ...
    :cond_8
    sget-object v3, Ljjq;->a:[Ljjn;

    invoke-static {v6, v3}, Ljgn;->a(Landroid/content/pm/PackageInfo;[Ljjn;)Ljjn;
    ...
    :cond_c
    sget-object v3, Ljgm;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Ljjf;->a(Landroid/content/Context;)I
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, p0}, Ljmr;->a(Landroid/content/Context;)Ljmq;
    ...
    invoke-virtual {v2, v3, v4}, Ljmq;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v2, v3}, Ljgn;->a(Landroid/content/pm/PackageInfo;[Ljjn;)Ljjn;
