...
.method constructor <init>(Landroid/os/storage/StorageManager;Lkvc;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Libn;->c:Landroid/os/storage/StorageManager;

    .line 3
    iput-object p2, p0, Libn;->b:Lkvc;
...
# virtual methods
.method public final a(Liai;)J
    .locals 5

    .prologue
    .line 4
    :try_start_0
    iget-object v0, p0, Libn;->b:Lkvc;
    ...
    invoke-interface {p1}, Liai;->c()Ljava/lang/String;
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Libn;->c:Landroid/os/storage/StorageManager;

    invoke-interface {p1}, Liai;->a()Ljava/io/File;
    ...
    .line 9
    iget-object v1, p0, Libn;->c:Landroid/os/storage/StorageManager;
