...
.method public constructor <init>(Lcom/google/android/apps/refocus/viewer/RGBZViewer;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/Runnable;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Ljev;->a:Lcom/google/android/apps/refocus/viewer/RGBZViewer;

    iput-object p2, p0, Ljev;->c:Lcom/google/android/apps/refocus/image/RGBZ;

    iput-object p3, p0, Ljev;->b:Ljava/lang/Runnable;
...
.method public final run()V
    ...
    .prologue
    .line 2
    iget-object v1, p0, Ljev;->a:Lcom/google/android/apps/refocus/viewer/RGBZViewer;

    iget-object v2, p0, Ljev;->c:Lcom/google/android/apps/refocus/image/RGBZ;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Ljev;->b:Ljava/lang/Runnable;
    ...
    invoke-direct {v0, v3}, Ljeo;-><init>(Lcom/google/android/apps/refocus/image/RGBZ;)V

    iput-object v0, v1, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->i:Ljeo;
    ...
    iget-object v4, v1, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->e:Lbtj;

    invoke-direct {v0, v3, v4}, Lcom/google/android/apps/refocus/processing/FaceDetector;-><init>(Landroid/content/Context;Lbtj;)V
    ...
    iget-object v4, v1, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->i:Ljeo;

    invoke-static {v0, v3, v4}, Lcom/google/android/apps/refocus/processing/FocusSettings;->createDefault(Lcom/google/android/apps/refocus/processing/FaceDetector;Lcom/google/android/apps/refocus/image/RGBZ;Ljeo;)Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    .line 16
    :goto_1
    iget-object v3, v1, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->i:Ljeo;
    ...
    .line 17
    invoke-virtual {v3, v4, v5}, Ljeo;->a(FF)F
