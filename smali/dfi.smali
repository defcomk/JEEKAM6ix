...
.field private final f:Ldfc;

.field private final g:Lafi;


# direct methods
.method public constructor <init>(Ldfm;Lmfh;Lafi;Lded;Ldfc;)V
    .locals 2
    ...
    .line 2
    iput-object p1, p0, Ldfi;->d:Ldfm;

    .line 3
    iput-object p2, p0, Ldfi;->c:Lmfh;

    .line 4
    iput-object p3, p0, Ldfi;->g:Lafi;

    .line 5
    iput-object p4, p0, Ldfi;->e:Lded;

    .line 6
    iput-object p5, p0, Ldfi;->f:Ldfc;
...
.method public final a()I
    ...
    .prologue
    .line 61
    iget-object v0, p0, Ldfi;->e:Lded;

    invoke-virtual {v0}, Lded;->a()I
...
.method public final a(Landroid/view/ViewGroup;I)Lvy;
    ...
    iget-object v2, p0, Ldfi;->f:Ldfc;

    invoke-direct {v1, p0, v0, v2}, Ldfe;-><init>(Ldfi;Landroid/widget/FrameLayout;Ldfc;)V
    ...
    invoke-direct {v1, v0}, Ldfl;-><init>(Landroid/widget/FrameLayout;)V
...
.method public final a(Lvy;)V
    ...
    invoke-virtual {p1, v0}, Ldfd;->b(Z)V
...
.method public final a(Lvy;I)V
    ...
    invoke-virtual {v0, p2}, Lded;->a(I)Ldee;

    move-result-object v3

    .line 20
    invoke-virtual {v3}, Ldee;->a()Z
    ...
    .line 26
    :goto_1
    iget-object v5, p1, Ldfl;->q:Landroid/widget/TextView;
    ...
    .line 28
    iget-object v0, p1, Ldfl;->p:Landroid/widget/TextView;
    ...
    .line 32
    iget-object v4, p0, Ldfi;->g:Lafi;

    .line 33
    iget-object v0, v3, Ldee;->a:Lbty;

    .line 34
    iget-object v5, p0, Ldfi;->c:Lmfh;

    invoke-interface {v5}, Lmfh;->b()Ljava/lang/Object;
    ...
    .line 35
    :goto_3
    iget-object v5, v3, Ldee;->a:Lbty;

    .line 36
    iget-object v6, v5, Lbwb;->c:Lbvz;
    ...
    .line 39
    iput-object v6, p1, Ldfe;->t:Landroid/net/Uri;
    ...
    .line 42
    invoke-virtual {p1, v2}, Ldfe;->b(Z)V

    .line 43
    invoke-virtual {p1, v4, v5}, Ldfe;->a(Lafi;Lbty;)V

    .line 44
    invoke-virtual {p1, v0}, Ldfe;->c(Z)V

    .line 45
    iget v0, v3, Ldee;->c:I

    .line 46
    iget-object v4, p1, Ldfe;->p:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
    ...
    invoke-direct {v0, p0, p1, v3}, Ldfj;-><init>(Ldfi;Ldfe;Ldee;)V

    invoke-virtual {p0, v0}, Ldfi;->a(Lva;)V
