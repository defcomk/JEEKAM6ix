...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lezx;->i:Landroid/graphics/Point;

    .line 4
    new-array v0, v1, [F

    iput-object v0, p0, Lezx;->l:[F

    .line 5
    new-array v0, v1, [F

    iput-object v0, p0, Lezx;->p:[F
    ...
    iput-object v0, p0, Lezx;->m:Ljava/util/ArrayList;
...
.method private final a(Landroid/content/Context;I)Z
    ...
    .line 9
    iget-object v3, p0, Lezx;->d:Ljava/util/Vector;

    invoke-virtual {v3, v2, v0}, Ljava/util/Vector;->add(ILjava/lang/Object;)V

    .line 10
    iget-object v3, p0, Lezx;->m:Ljava/util/ArrayList;
    ...
    .line 14
    iget-object v0, p0, Lezx;->i:Landroid/graphics/Point;
    ...
    .line 15
    :try_start_0
    iget-object v0, p0, Lezx;->d:Ljava/util/Vector;
    ...
    iput-object v0, p0, Lezx;->e:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lezx;->c:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lezx;->a:Ljava/nio/ShortBuffer;

    .line 40
    iget-object v0, p0, Lezx;->e:Ljava/nio/FloatBuffer;

    invoke-virtual {v0}, Ljava/nio/FloatBuffer;->clear()Ljava/nio/Buffer;

    .line 41
    iget-object v0, p0, Lezx;->c:Ljava/nio/FloatBuffer;

    invoke-virtual {v0}, Ljava/nio/FloatBuffer;->clear()Ljava/nio/Buffer;

    .line 42
    iget-object v0, p0, Lezx;->a:Ljava/nio/ShortBuffer;
    ...
    .line 47
    iget-object v4, p0, Lezx;->a:Ljava/nio/ShortBuffer;
    ...
    :cond_1
    iget-object v4, p0, Lezx;->c:Ljava/nio/FloatBuffer;
...
.method public final a()V
    ...
    .prologue
    .line 72
    iget-object v2, p0, Lezx;->m:Ljava/util/ArrayList;
    ...
    .line 75
    :cond_1
    iget-object v0, p0, Lezx;->m:Ljava/util/ArrayList;
...
.method public final a([FFFF)V
    ...
    iget-object v2, p0, Lezx;->e:Ljava/nio/FloatBuffer;

    invoke-virtual {v0, v2}, Lfft;->a(Ljava/nio/FloatBuffer;)V

    .line 63
    iget-object v0, p0, Lezx;->b:Lfft;

    iget-object v2, p0, Lezx;->c:Ljava/nio/FloatBuffer;

    invoke-virtual {v0, v2}, Lfft;->b(Ljava/nio/FloatBuffer;)V

    .line 64
    iget-object v0, p0, Lezx;->l:[F
    ...
    iget-object v2, p0, Lezx;->l:[F

    invoke-virtual {v0, v2}, Lfft;->b([F)V
    ...
    iget-object v3, p0, Lezx;->a:Ljava/nio/ShortBuffer;
...
.method public final a(Landroid/content/Context;IF)Z
    ...
    .line 51
    invoke-direct {p0, p1, p2}, Lezx;->a(Landroid/content/Context;I)Z
    ...
    .line 54
    iget-object v3, p0, Lezx;->e:Ljava/nio/FloatBuffer;
