...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lden;->n:Ljava/lang/String;
...
.method public constructor <init>(Ldew;)V
    ...
    iput-object v0, p0, Lden;->j:Ljava/util/List;
    ...
    iput-object v0, p0, Lden;->a:Ljava/util/Map;

    .line 4
    iput-object p1, p0, Lden;->g:Ldew;
...
.method private static a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 11
    :cond_0
    sget-object v0, Lden;->n:Ljava/lang/String;
...
# virtual methods
.method final a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Loak;)Ldez;
    .locals 10
    ...
    .line 28
    invoke-static {p1}, Lden;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v1

    .line 29
    invoke-static {p2}, Lden;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v2

    .line 30
    iget-object v0, p0, Lden;->j:Ljava/util/List;

    iget-object v3, p0, Lden;->k:Landroid/support/v4/view/ViewPager;
    ...
    .line 39
    invoke-static {v1, v3}, Lden;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v0

    .line 40
    invoke-static {v0, v2}, Lden;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct/range {v0 .. v6}, Ldez;-><init>(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;FFFLandroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public final a()V
    ...
    .line 53
    iget-object v0, p0, Lden;->m:Ldez;

    if-eqz v0, :cond_1

    .line 54
    iget-object v0, p0, Lden;->l:Landroid/animation/Animator;
    ...
    .line 56
    :cond_0
    iget-object v0, p0, Lden;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 57
    invoke-virtual {p0, v0}, Lden;->a(Landroid/net/Uri;)V

    .line 58
    iput-boolean v2, p0, Lden;->f:Z
    ...
    .line 61
    invoke-virtual {p0, v0}, Lden;->a(I)V

    const/4 v0, 0x0

    .line 62
    iput-object v0, p0, Lden;->m:Ldez;
    ...
    .line 63
    :cond_2
    iget-object v3, p0, Lden;->g:Ldew;

    iget-object v0, p0, Lden;->j:Ljava/util/List;

    iget-object v1, p0, Lden;->k:Landroid/support/v4/view/ViewPager;
    ...
    .line 67
    :goto_1
    iget-object v5, v3, Ldew;->a:Lddt;

    .line 68
    iget-object v5, v5, Lddt;->k:Lded;
    ...
    .line 72
    invoke-virtual {v5, v1}, Lded;->a(I)Ldee;
    ...
    .line 74
    iget-object v5, v5, Ldee;->a:Lbty;

    .line 75
    iget-object v5, v5, Lbwb;->c:Lbvz;

    .line 76
    iget-object v5, v5, Lbvc;->d:Lfig;

    .line 77
    iget-object v5, v5, Lfig;->m:Landroid/net/Uri;

    .line 78
    iget-object v6, v0, Lbwb;->c:Lbvz;
    ...
    .line 81
    invoke-static {v5, v6}, Lmea;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 82
    iget-object v0, v3, Ldew;->a:Lddt;

    .line 83
    iget-object v0, v0, Lddt;->f:Ldfa;

    .line 84
    invoke-virtual {v0, v1}, Ldfa;->a(I)Ldfe;
    ...
    .line 89
    iget-object v3, p0, Lden;->a:Ljava/util/Map;
    ...
    .line 90
    iget-object v1, p0, Lden;->m:Ldez;

    .line 91
    :goto_3
    iget-object v3, v1, Ldez;->c:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
    ...
    invoke-direct {v6, v0, v1}, Ldem;-><init>(Loak;Ldez;)V
    ...
    iget-object v6, p0, Lden;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v6, p0, Lden;->i:Landroid/view/View;
    ...
    invoke-direct {v1, p0, v3, v0}, Ldes;-><init>(Lden;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Loak;)V
    ...
    .line 109
    iput-object v4, p0, Lden;->l:Landroid/animation/Animator;
    ...
    .line 111
    :cond_3
    iget-object v1, v1, Ldfe;->p:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    .line 112
    invoke-virtual {p0, v1, v0}, Lden;->a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Loak;)Ldez;
...
.method public final a(I)V
    ...
    .line 134
    iget-object v0, p0, Lden;->k:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, p1}, Landroid/support/v4/view/ViewPager;->setVisibility(I)V

    .line 135
    iget-object v0, p0, Lden;->i:Landroid/view/View;
...
.method public final a(Landroid/net/Uri;)V
    ...
    .line 115
    iget-object v2, p0, Lden;->b:Landroid/view/ViewGroup;
    ...
    invoke-direct {v0, p0, p1}, Ldev;-><init>(Lden;Landroid/net/Uri;)V
    ...
    invoke-direct {v0, p0, p1}, Ldeu;-><init>(Lden;Landroid/net/Uri;)V
    ...
    invoke-direct {v3, p0, p1}, Ldet;-><init>(Lden;Landroid/net/Uri;)V
