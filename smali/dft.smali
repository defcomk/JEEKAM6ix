...
# direct methods
.method constructor <init>(Landroid/app/Activity;Landroid/view/LayoutInflater;Landroid/content/res/Resources;Ldhm;Lhuf;)V
    .locals 4
    ...
    iput-object v0, p0, Ldft;->c:Ljava/lang/ref/WeakReference;

    .line 3
    iget-object v0, p4, Ldhm;->f:Landroid/widget/LinearLayout;

    iput-object v0, p0, Ldft;->k:Landroid/view/ViewGroup;

    .line 4
    iget-object v0, p4, Ldhm;->g:Landroid/widget/FrameLayout;

    iput-object v0, p0, Ldft;->l:Landroid/view/ViewGroup;

    .line 5
    iget-object v0, p0, Ldft;->k:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Ldft;->d:Landroid/view/View;
    ...
    iput-object v0, p0, Ldft;->i:Landroid/widget/ImageButton;

    .line 8
    iget-object v0, p0, Ldft;->i:Landroid/widget/ImageButton;

    new-instance v2, Ldfu;

    invoke-direct {v2, p0}, Ldfu;-><init>(Ldft;)V
    ...
    iput-object v0, p0, Ldft;->j:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldft;->r:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/ExternalViewerButton;

    .line 13
    iget-object v0, p0, Ldft;->r:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/ExternalViewerButton;

    new-instance v2, Ldfv;

    invoke-direct {v2, p0}, Ldfv;-><init>(Ldft;)V
    ...
    iput-object v0, p0, Ldft;->s:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldft;->g:Landroid/widget/ImageButton;

    .line 16
    iget-object v0, p0, Ldft;->g:Landroid/widget/ImageButton;

    new-instance v2, Ldfw;

    invoke-direct {v2, p0}, Ldfw;-><init>(Ldft;)V
    ...
    iput-object v0, p0, Ldft;->h:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldft;->e:Landroid/widget/ImageButton;

    .line 19
    iget-object v0, p0, Ldft;->e:Landroid/widget/ImageButton;

    new-instance v2, Ldfx;

    invoke-direct {v2, p0}, Ldfx;-><init>(Ldft;)V
    ...
    iput-object v0, p0, Ldft;->f:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldft;->p:Landroid/widget/ImageButton;

    .line 22
    iget-object v0, p0, Ldft;->p:Landroid/widget/ImageButton;

    new-instance v2, Ldfy;

    invoke-direct {v2, p0}, Ldfy;-><init>(Ldft;)V
    ...
    iput-object v0, p0, Ldft;->q:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldft;->o:Landroid/view/View;
    ...
    .line 26
    iget-object v0, p0, Ldft;->o:Landroid/view/View;
    ...
    iput-object v0, p0, Ldft;->n:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ldft;->m:Landroid/view/View;

    .line 29
    iget-object v0, p0, Ldft;->m:Landroid/view/View;

    new-instance v1, Ldfz;

    invoke-direct {v1, p0}, Ldfz;-><init>(Ldft;)V
    ...
    .line 30
    invoke-virtual {p5, v0, v1}, Lhuf;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 35
    iget-object v2, p0, Ldft;->l:Landroid/view/ViewGroup;
    ...
    .line 36
    iget-object v1, p0, Ldft;->r:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/ExternalViewerButton;
...
.method public final a(Lbfu;)V
    ...
    .line 45
    iget-object v3, p0, Ldft;->r:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/ExternalViewerButton;
    ...
    .line 52
    iget-object v0, p0, Ldft;->s:Landroid/widget/FrameLayout;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    .line 65
    iget-object v0, p0, Ldft;->n:Landroid/widget/TextView;
...
.method public final b()V
    ...
    .prologue
    .line 67
    iget-object v0, p0, Ldft;->d:Landroid/view/View;
...
.method public final b(Z)V
    ...
    .prologue
    .line 43
    iget-object v1, p0, Ldft;->i:Landroid/widget/ImageButton;
    ...
    .line 44
    iget-object v1, p0, Ldft;->j:Landroid/widget/FrameLayout;
...
.method public final d()V
    ...
    .line 71
    iget-object v2, p0, Ldft;->r:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/ExternalViewerButton;
    ...
    .line 75
    iget-object v1, p0, Ldft;->l:Landroid/view/ViewGroup;
...
.method public final d(Z)V
    ...
    .prologue
    .line 56
    iget-object v1, p0, Ldft;->e:Landroid/widget/ImageButton;
    ...
    .line 57
    iget-object v1, p0, Ldft;->f:Landroid/widget/FrameLayout;
...
.method public final e(Z)V
    ...
    .prologue
    .line 58
    iget-object v1, p0, Ldft;->g:Landroid/widget/ImageButton;
    ...
    .line 59
    iget-object v1, p0, Ldft;->h:Landroid/widget/FrameLayout;
...
.method public final f(Z)V
    ...
    .prologue
    .line 60
    iget-object v1, p0, Ldft;->p:Landroid/widget/ImageButton;
    ...
    .line 61
    iget-object v1, p0, Ldft;->q:Landroid/widget/FrameLayout;
