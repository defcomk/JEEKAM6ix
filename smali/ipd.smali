...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lipd;->setScaleType(Landroid/widget/ImageView$ScaleType;)V

    .line 5
    new-instance v0, Lipe;

    invoke-direct {v0, p0}, Lipe;-><init>(Lipd;)V

    invoke-virtual {p0, v0}, Lipd;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V
...
.method public final a()V
    ...
    .prologue
    .line 6
    iget-object v0, p0, Lipd;->c:Lipf;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lipf;->isCancelled()Z
    ...
    invoke-virtual {v0, v1}, Lipf;->cancel(Z)Z

    const/16 v0, 0x8

    .line 8
    invoke-virtual {p0, v0}, Lipd;->setVisibility(I)V
...
.method final b()Ljava/io/InputStream;
    ...
    .line 23
    :try_start_0
    invoke-virtual {p0}, Lipd;->getContext()Landroid/content/Context;
    ...
    iget-object v1, p0, Lipd;->d:Landroid/net/Uri;
