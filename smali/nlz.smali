...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    .line 5
    :cond_2
    iput-object p1, p0, Lnlz;->b:Landroid/content/ContentProviderClient;

    const-string v0, "device_params"

    .line 6
    invoke-static {p2, v0}, Lndv;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lnlz;->c:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lnlz;->f:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lnlz;->d:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lnlz;->e:Landroid/net/Uri;
...
.method private final a(Lniv;Landroid/net/Uri;Ljava/lang/String;)Lniv;
    .locals 7
    ...
    .line 18
    :try_start_0
    iget-object v0, p0, Lnlz;->b:Landroid/content/ContentProviderClient;
    ...
    :try_end_1
    .catch Lniu; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 23
    invoke-static {p1, v0}, Lniv;->mergeFrom(Lniv;[B)Lniv;
    :try_end_2
    .catch Lniu; {:try_start_2 .. :try_end_2} :catch_1
    ...
    :goto_2
    :try_start_3
    sget-object v2, Lnlz;->a:Ljava/lang/String;
...
.method private final a(Lniv;Landroid/net/Uri;)Z
    .locals 5
    ...
    .line 30
    iget-object v2, p0, Lnlz;->b:Landroid/content/ContentProviderClient;
    ...
    .line 31
    :cond_1
    iget-object v1, p0, Lnlz;->b:Landroid/content/ContentProviderClient;
...
.method public final a(Lnnm;)Lmua;
    ...
    .line 15
    sget-object v1, Lnna;->a:Lmua;

    iget-object v2, p0, Lnlz;->e:Landroid/net/Uri;

    invoke-direct {p0, v1, v2, v0}, Lnlz;->a(Lniv;Landroid/net/Uri;Ljava/lang/String;)Lniv;
...
.method public final a()Lnne;
    ...
    iget-object v1, p0, Lnlz;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lnlz;->a(Lniv;Landroid/net/Uri;Ljava/lang/String;)Lniv;
...
.method public final a(Lnne;)Z
    ...
    .prologue
    .line 12
    iget-object v0, p0, Lnlz;->c:Landroid/net/Uri;

    invoke-direct {p0, p1, v0}, Lnlz;->a(Lniv;Landroid/net/Uri;)Z
...
.method public final b()Lnnh;
    ...
    iget-object v1, p0, Lnlz;->d:Landroid/net/Uri;
