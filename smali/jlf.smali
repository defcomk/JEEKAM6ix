...
# direct methods
.method constructor <init>(Ljgx;Lcom/google/android/gms/feedback/FeedbackOptions;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 0

    iput-object p2, p0, Ljlf;->d:Lcom/google/android/gms/feedback/FeedbackOptions;

    iput-object p3, p0, Ljlf;->a:Landroid/os/Bundle;

    iput-wide p4, p0, Ljlf;->b:J

    iput-object p6, p0, Ljlf;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    invoke-direct {p0, p1}, Ljli;-><init>(Ljgx;)V
...
.method protected final a(Ljlk;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Ljlf;->d:Lcom/google/android/gms/feedback/FeedbackOptions;

    iget-object v1, p0, Ljlf;->a:Landroid/os/Bundle;

    iget-wide v2, p0, Ljlf;->b:J

    iget-object v4, p0, Ljlf;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Ljlg;

    invoke-direct {v5, p0}, Ljlg;-><init>(Ljlf;)V
    ...
    :goto_2
    invoke-interface {v5}, Ljkw;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Ljlf;->c(Lcom/google/android/gms/common/api/Status;)V
