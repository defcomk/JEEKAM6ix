...
.method private constructor <init>(Ljgx;)V
    ...
    sget-object v0, Ljsp;->c:Ljgt;

    invoke-direct {p0, v0, p1}, Ljpc;-><init>(Ljgt;Ljgx;)V

    return-void
.end method

.method private constructor <init>(Ljgx;B)V
    .locals 0

    invoke-direct {p0, p1}, Ljnd;-><init>(Ljgx;)V

    return-void
.end method

.method constructor <init>(Ljgx;Landroid/net/Uri;)V
    .locals 1

    iput-object p2, p0, Ljnd;->a:Landroid/net/Uri;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Ljnd;-><init>(Ljgx;B)V
...
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Ljhe;
    ...
    invoke-direct {v0, p1, v1}, Ljnf;-><init>(Lcom/google/android/gms/common/api/Status;Landroid/content/Intent;)V
...
.method protected final synthetic a(Ljgs;)V
    ...
    iget-object v1, p1, Ljhz;->a:Landroid/content/Context;

    invoke-virtual {p1}, Ljne;->p()Landroid/os/IInterface;
    ...
    invoke-direct {v2, p0}, Ljnc;-><init>(Ljpd;)V

    iget-object v3, p0, Ljnd;->a:Landroid/net/Uri;
    ...
    invoke-direct {v4, v1, v3, v2}, Ljnb;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljmx;)V
    ...
    invoke-interface {v4}, Ljmx;->asBinder()Landroid/os/IBinder;
    ...
    iget-object v0, v0, Ljmz;->a:Landroid/os/IBinder;
