...
# direct methods
.method public constructor <init>(Ldfi;Landroid/widget/FrameLayout;Ldfc;)V
    .locals 4
    ...
    .line 1
    invoke-direct {p0, p2}, Ldfd;-><init>(Landroid/widget/FrameLayout;)V

    .line 2
    iget-object v0, p1, Ldfi;->d:Ldfm;

    .line 3
    iput-object v0, p0, Ldfe;->r:Ldfm;

    .line 4
    iput-object p2, p0, Ldfe;->u:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Ldfe;->p:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
    ...
    iput-object v0, p0, Ldfe;->v:Landroid/widget/FrameLayout;

    .line 7
    iget-object v0, p0, Ldfe;->p:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    new-instance v1, Ldff;

    invoke-direct {v1, p0, p3}, Ldff;-><init>(Ldfe;Ldfc;)V
    ...
    invoke-direct {v1, p0, p3}, Ldfg;-><init>(Ldfe;Ldfc;)V
    ...
    iput-object v0, p0, Ldfe;->x:Landroid/animation/ValueAnimator;

    .line 15
    iget-object v0, p0, Ldfe;->x:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Ldfh;-><init>(Ldfe;)V
...
.method final a(F)V
    ...
    .line 35
    iget-object v1, p0, Ldfe;->v:Landroid/widget/FrameLayout;
    ...
    .line 36
    iget-object v0, p0, Ldfe;->v:Landroid/widget/FrameLayout;
...
.method public final a(Lafi;Lbty;)V
    .locals 8
    ...
    .line 42
    iget-object v3, p2, Lbwb;->c:Lbvz;

    .line 43
    iget-object v3, v3, Lbvc;->d:Lfig;

    .line 44
    iget-object v4, v3, Lfig;->i:Ljava/lang/String;
    ...
    .line 59
    iget-object v0, p0, Ldfe;->t:Landroid/net/Uri;
    ...
    .line 61
    iput-object v0, p0, Ldfe;->q:Laff;

    .line 62
    iget-object v0, p0, Ldfe;->q:Laff;

    iget-object v1, p0, Ldfe;->p:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
...
.method public final b(Z)V
    ...
    .line 20
    iget-object v3, p0, Ldfe;->t:Landroid/net/Uri;

    .line 21
    invoke-virtual {v0, v3}, Ldfm;->a(Landroid/net/Uri;)Z

    move-result v3

    .line 22
    iget-object v0, p0, Ldfe;->u:Landroid/widget/FrameLayout;
    ...
    .line 31
    :cond_1
    invoke-virtual {p0, v5}, Ldfe;->a(F)V
    ...
    invoke-virtual {p0, v0}, Ldfe;->a(F)V
