...
# direct methods
.method public constructor <init>(Lkdq;ILkeo;Lmed;Lmed;Lkfp;Lkih;Lkck;)V
    .locals 6
    ...
    iput-object v0, p0, Lkes;->d:Lnar;

    .line 106
    new-instance v0, Lkgh;

    invoke-direct {v0, p0}, Lkgh;-><init>(Lkes;)V

    iput-object v0, p0, Lkes;->u:Landroid/media/MediaCodec$Callback;

    const-wide v0, 0x7fffffffffffffffL

    .line 107
    iput-wide v0, p0, Lkes;->p:J
    ...
    iput-object v0, p0, Lkes;->l:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v0, p0, Lkes;->h:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 112
    iput-boolean v0, p0, Lkes;->g:Z

    const/4 v0, 0x0

    .line 113
    iput-boolean v0, p0, Lkes;->y:Z

    const/4 v0, 0x0

    .line 114
    iput-boolean v0, p0, Lkes;->e:Z

    .line 115
    iput-object p6, p0, Lkes;->c:Lkfp;

    .line 116
    iput-object p8, p0, Lkes;->w:Lkck;
    ...
    invoke-static {v0}, Lkdv;->a(I)Lkdv;

    move-result-object v0

    .line 118
    iget-object v1, v0, Lkdv;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Lkes;->j:Landroid/media/MediaCodec;

    .line 141
    iget-object v0, p0, Lkes;->j:Landroid/media/MediaCodec;
    ...
    iput-object v0, p0, Lkes;->b:Landroid/os/HandlerThread;

    .line 143
    iget-object v0, p0, Lkes;->b:Landroid/os/HandlerThread;
    ...
    iget-object v3, p0, Lkes;->b:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lkes;->a:Landroid/os/Handler;
    ...
    .line 147
    iput-boolean v0, p0, Lkes;->x:Z

    .line 148
    :goto_0
    iget-object v0, p0, Lkes;->j:Landroid/media/MediaCodec;

    iget-object v3, p0, Lkes;->u:Landroid/media/MediaCodec$Callback;

    iget-object v4, p0, Lkes;->a:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lkes;->r:Landroid/view/Surface;

    .line 154
    iget-object v0, p0, Lkes;->j:Landroid/media/MediaCodec;

    iget-object v2, p0, Lkes;->r:Landroid/view/Surface;

    invoke-virtual {v0, v2}, Landroid/media/MediaCodec;->setInputSurface(Landroid/view/Surface;)V

    .line 155
    :goto_1
    iput-object p3, p0, Lkes;->k:Lkeo;

    .line 156
    iput-object p7, p0, Lkes;->A:Lkih;
    ...
    .line 162
    iput-object v0, p0, Lkes;->t:Landroid/util/Range;
    ...
    iput-object v0, p0, Lkes;->i:Ljava/lang/Object;
...
.method private final a()V
    ...
    .prologue
    .line 100
    iget-object v0, p0, Lkes;->a:Landroid/os/Handler;

    new-instance v1, Lkgg;

    invoke-direct {v1, p0}, Lkgg;-><init>(Lkes;)V
...
.method private final c(J)Z
    ...
    .line 52
    iget-object v1, p0, Lkes;->i:Ljava/lang/Object;
    ...
    .line 56
    iget-object v0, p0, Lkes;->r:Landroid/view/Surface;
...
.method public final a(F)I
    ...
    .line 4
    iget-object v2, p0, Lkes;->t:Landroid/util/Range;
    ...
    .line 8
    iget-object v3, p0, Lkes;->j:Landroid/media/MediaCodec;
    ...
    .line 11
    invoke-static {v0}, Lkgi;->a(I)Ljava/lang/String;
...
.method public final a(ILandroid/media/MediaCodec$BufferInfo;)Z
    ...
    iget-boolean v0, p0, Lkes;->f:Z

    if-nez v0, :cond_5

    :goto_4
    iget-boolean v0, p0, Lkes;->y:Z

    if-nez v0, :cond_4

    iget-boolean v0, p0, Lkes;->e:Z
    ...
    invoke-virtual {v0, v1, p2}, Lkeo;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    .line 84
    iput-boolean v5, p0, Lkes;->g:Z

    .line 85
    iget-wide v0, p2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    .line 86
    iget-wide v2, p0, Lkes;->z:J
    ...
    .line 88
    iget-object v0, p0, Lkes;->l:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-virtual {v4}, Lkeo;->d()Lkel;

    move-result-object v4

    .line 91
    iget-wide v6, v4, Lkel;->a:J

    add-long/2addr v2, v6

    iput-wide v2, v4, Lkel;->a:J
    ...
    .line 96
    :cond_e
    iget-object v0, p0, Lkes;->h:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 98
    iput-boolean v5, p0, Lkes;->y:Z

    .line 99
    iget-object v0, p0, Lkes;->c:Lkfp;
...
.method public final b(J)V
    ...
    :cond_5
    :goto_5
    iget-boolean v0, p0, Lkes;->x:Z

    if-nez v0, :cond_6

    .line 35
    sget-object v0, Lkfo;->b:Lkfo;

    iget-wide v2, p0, Lkes;->p:J

    iget-object v4, p0, Lkes;->h:Ljava/util/concurrent/atomic/AtomicLong;

    iget-object v5, p0, Lkes;->d:Lnar;
    ...
    invoke-direct {v2, p0}, Lkge;-><init>(Lkes;)V
    ...
    .line 42
    :cond_8
    invoke-direct {p0, p1, p2}, Lkes;->c(J)Z
    ...
    .line 49
    :cond_b
    invoke-virtual {p0, p1, p2}, Lkes;->a(J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final close()V
    ...
    invoke-virtual {p0, v0, v1}, Lkes;->b(J)V
