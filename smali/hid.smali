...
# direct methods
.method public constructor <init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lffh;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhid;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iput-object p2, p0, Lhid;->b:Lffh;
...
.method public final run()V
    ...
    .prologue
    .line 1
    iget-object v1, p0, Lhid;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iget-object v2, p0, Lhid;->b:Lffh;

    .line 2
    :goto_0
    :try_start_0
    iget-object v0, v1, Lcom/google/android/apps/camera/processing/ProcessingService;->n:Lhil;

    invoke-virtual {v0}, Lhil;->a()Lhik;
    ...
    .line 4
    :try_start_1
    iput-object v0, v1, Lcom/google/android/apps/camera/processing/ProcessingService;->c:Lhik;
    ...
    .line 16
    iget-object v4, v1, Lcom/google/android/apps/camera/processing/ProcessingService;->c:Lhik;

    invoke-interface {v4}, Lhik;->suspend()V
    ...
    .line 18
    :try_start_6
    invoke-interface {v0}, Lhik;->getUsageStatsName()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lffh;->a(Ljava/lang/String;)V
    ...
    .line 22
    invoke-interface {v0}, Lhik;->getSession()Lhij;
    ...
    .line 23
    invoke-interface {v3, v1}, Lhij;->a(Lhim;)V
    ...
    .line 25
    iget-object v3, v1, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lhio;

    invoke-interface {v0}, Lhik;->getUsageStatsName()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lhio;->a(Ljava/lang/String;)V
    ...
    .line 27
    invoke-interface {v0, v1}, Lhik;->process(Landroid/content/Context;)V
    ...
    .line 31
    :try_start_7
    iget-object v3, v1, Lcom/google/android/apps/camera/processing/ProcessingService;->f:Lkae;

    new-instance v4, Lhie;

    invoke-direct {v4, v0}, Lhie;-><init>(Ljava/lang/Exception;)V
